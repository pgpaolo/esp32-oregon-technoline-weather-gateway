...
<div class="cfgNote"><b>Principale:</b> alimenta meteo e MQTT legacy. I canali manuali restano visibili offline; Auto aggiunge quelli rilevati.</div>
</div>
...
<div class="cfgNote">TLS verificato usa la CA PEM inserita qui. La modalita TLS senza verifica cifra il traffico ma non autentica il broker: usala solo per test. I canali THGN CH1-CH3 seguono CONFIGURAZIONE &gt; OREGON. Password, CA e mask campi vengono scritti in NVS soltanto se cambiano.</div>
</div>
