...
assert 'Insecure = 1' in hdr  # preserve existing NVS value
assert 'CaVerified = 0' in hdr  # existing verified configs migrate to public trust automatically
...
print('MB public TLS integration: OK')
