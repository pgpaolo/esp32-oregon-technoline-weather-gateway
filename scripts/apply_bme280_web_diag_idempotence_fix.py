...
# declarations could have been inserted more than once. The manual deep I2C
# scanner is a separate authenticated endpoint added by the preceding compile
# compatibility pass and is intentionally not duplicated here.
